...
import net.defade.dungeons.zombies.specials.SpeedyZombie;
...
public class Wave {
    ...
    public DungeonsEntity getZombie() {
        ...
        if(zombieClass == ZombieIX.class) return new ZombieIX();

        if(zombieClass == SpeedyZombie.class) return new SpeedyZombie();
